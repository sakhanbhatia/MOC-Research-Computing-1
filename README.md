...
This document provides the technologies and procedures that we used in the project: [Knowledge Document](https://github.com/BU-CLOUD-S20/MOC-Research-Computing/blob/master/Knowledge%20Documents%20.pdf)
...
After speaking with the Harvard MIT Data Center team, they said that they acknowledge that cluster autoscaling is not supported on the MOC and we cannot replicate the same thing that they did on AWS. They said it is okay and that this part is not part of the scope of the project.
